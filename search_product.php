...
<div class="container-fluid p-0" style="background-image: url(./images/bg7.jpg);">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="cart.php">cart<i class="fa-solid fa-cart-shopping"></i><sup><sup><?php cart_item();?></sup></a>
              </li>
              <li class="nav-item">
